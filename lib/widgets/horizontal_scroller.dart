...
class HorizontalScroller extends StatelessWidget {
  ...
  const HorizontalScroller({super.key, required this.child, this.padding, this.controller});
  ...
  Widget build(BuildContext context) {
    ...
    final bool useScrollbar = Theme.of(context).platform == TargetPlatform.macOS ||
