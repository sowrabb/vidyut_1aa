...
class ResponsiveProductCard extends StatelessWidget {
  ...
  factory ResponsiveProductCard.demo(
              ...
              children: [
                ...
                Expanded(
                  child: _buildContentSection(
                      cardWidth, isSmallCard, isMobile, isDesktop),
                ),
              ],
            ),
          ),
  ...
  Widget _buildImageSection(bool isSmallCard, bool isDesktop) {
    ...
    final imageAspectRatio =
        isSmallCard ? 16 / 10 : 16 / 12; // Slightly taller for larger cards
  ...
  Widget _buildContentSection(
      double cardWidth, bool isSmallCard, bool isMobile, bool isDesktop) {
    ...
    final titleSize =
        _getAdaptiveTextSize(cardWidth, base: 13, min: 10, max: 14);
    final subtitleSize =
        _getAdaptiveTextSize(cardWidth, base: 10, min: 8, max: 10);
    final priceSize =
        _getAdaptiveTextSize(cardWidth, base: 14, min: 12, max: 16);
